        ...
        var r = t("html, body"),
            ...
            u = function(o, l) {
                var u = t(o),
                            ...
                            m = {
                                loaded: function() {
                                    ...
                                    f && c ? f && v(o.url) : u.one(t, function() {
                                        v(o.url), n || R(o.url)
                                    }), i && (d = l.alterChangeState({
                                        id: h
                                    }, p[o.url].title, o.url), p[o.url].state = d, e.history.pushState(d, p[o.url].title, o.url)), f && !n && R(o.url)
                                },
                                fetching: function() {
                    ...
                    k = function(t) {
                        l.anchors && (t.on("click", l.anchors, w), O(t)), l.forms && t.on("submit", l.forms, b)
                    },
                    C = function() {
                        var t = u.prop("class");
                        u.removeClass(t), a.redraw(u), u.addClass(t)
                    };
                return l = t.extend({}, t.fn.smoothState.options, l), null === e.history.state ? (d = l.alterChangeState({
                    id: h
                }, i.title, m), e.history.replaceState(d, i.title, m)) : d = {}, a.storePageIn(p, m, i.documentElement.outerHTML, h, d), a.triggerAllAnimationEndEvent(u, "ss.onStartEnd ss.onProgressEnd ss.onEndEnd"), k(u), {
                    href: m,
                    cache: p,
                    clear: R,
                    load: y,
    ...
    if (!n.TweenLite) {
                ...
                this.check = function(h) {
                    ...
                    if (0 === v && o) {
                        if (f = ("com.greensock." + r).split("."), p = f.pop(), d = u(f.join("."))[p] = this.gsClass = o.apply(o, l), a)
                            if (n[p] = d, g = "undefined" != typeof module && module.exports, !g && "function" == typeof define && define.amd) define((t.GreenSockAMDPath ? t.GreenSockAMDPath + "/" : "") + r.split(".").pop(), [], function() {
                                return d
                            });
                            else if (g)
                            if (r === e) {
        ...
        _("Ticker", function(t, e) {
            var i, n, r, s, o, u = this,
                ...
                g = function(t) {
                    var e, a, l = O() - k;
                    l > d && (h += l - m), k += l, u.time = (k - h) / 1e3, e = u.time - o, (!i || e > 0 || t === !0) && (u.frame++, o += e + (e >= s ? .004 : s - e), a = !0), t !== !0 && (r = n(g)), a && u.dispatchEvent(R)
                };
            T.call(u), u.time = u.frame = 0, u.tick = function() {
                ...
                null !== r ? u.sleep() : t ? h += -k + (k = O()) : u.frame > 10 && (k = O() - d + 5), n = 0 === i ? p : f && z ? z : function(t) {
        ...
        var E = _("TweenLite", function(e, i, n) {
                if (C.call(this, i, n), this.render = E.prototype.render, null == e) throw "Cannot tween a null target.";
                this.target = e = "string" != typeof e ? e : E.selector(e) || e;
                var r, s, o, a = e.jquery || e.length && e !== t && e[0] && (e[0] === t || e[0].nodeType && e[0].style && !e.nodeType),
                    l = this.vars.overwrite;
                if (this._overwrite = l = null == l ? G[E.defaultOverwrite] : "number" == typeof l ? l >> 0 : G[l], (a || e instanceof Array || e.push && d(e)) && "number" != typeof e[0])
        ...
        o = E.prototype = new C, o.constructor = E, o.kill()._gc = !1, o.ratio = 0, o._firstPT = o._targets = o._overwrittenProps = o._startAt = null, o._notifyPluginsOfEnabled = o._lazy = !1, E.version = "1.18.5", E.defaultEase = o._ease = new x(null, null, 1, 1), E.defaultOverwrite = "auto", E.ticker = a, E.autoSleep = 120, E.lagSmoothing = function(t, e) {
            a.lagSmoothing(t, e)
        ...
        var F = [],
            ...
            D = function(t, e, i, n, r, s, o, a) {
                ...
                return "number" !== c && ("function" === c && "get" === i && (u = e.indexOf("set") || "function" != typeof t["get" + e.substr(3)] ? e : "get" + e.substr(3), p.s = h = o ? t[u](o) : t[u]()), "string" == typeof h && (o || isNaN(h)) ? (p.fp = o, l = X(h, n, a || E.defaultStringFilter, p), p = {
                    t: l,
                    p: "setRatio",
                    s: 0,
                    c: 1,
        ...
        H._startTime = a.time, W._startTime = a.frame, H._active = W._active = !0, setTimeout(Z, 1), C._updateRoot = E.render = function() {
            var t, e, i;
            if (F.length && Z(), H.render((a.time - H._startTime) * H._timeScale, !1, !1), W.render((a.frame - W._startTime) * W._timeScale, !1, !1), F.length && Z(), a.frame >= Q) {
                Q = a.frame + (parseInt(E.autoSleep, 10) || 120);
                for (i in B) {
                    for (e = B[i].tweens, t = e.length; --t > -1;) e[t]._gc && e.splice(t, 1);
                    0 === e.length && delete B[i]
                }
                if (i = H._first, (!i || i._paused) && E.autoSleep && !W._first && 1 === a._listeners.tick.length) {
        ...
        o._init = function() {
            ...
            for (s in this.vars)
                ...
                else if (V[s] && (l = new V[s])._onInitTween(e, this.vars[s], this)) {
                for (this._firstPT = u = {
                        _next: this._firstPT,
                        t: l,
                        p: "setRatio",
            ...
            if ((d(e) || M(e)) && "number" != typeof e[0])
                ...
                if (a) {
                    if (u = t || a, h = t !== r && "all" !== r && t !== a && ("object" != typeof t || !t._tempKill), i && (E.onOverwrite || this.vars.onOverwrite)) {
            ...
            return C.prototype._enabled.call(this, t, e), !(!this._notifyPluginsOfEnabled || !this._firstPT) && E._onPluginEvent(t ? "_onEnable" : "_onDisable", this)
        }, E.to = function(t, e, i) {
            return new E(t, e, i)
        ...
        if (o = et.prototype, et.version = "1.18.0", et.API = 2, o._firstPT = null, o._addTween = D, o.setRatio = j, o._kill = function(t) {
        ...
        _gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function(t, e) {
            ...
            var h, c, f, p, d, m, R = /(?:\-|\.|\b)(\d|\.|e\-)+/g,
                ...
                H = function(t, e) {
                    ...
                    return n >= 0 ? (W = 3 === n ? "ms" : i[n], G = "-" + W.toLowerCase() + "-", W + t) : null
                },
                Q = L.defaultView ? L.defaultView.getComputedStyle : function() {},
                Z = o.getStyle = function(t, e, i, n, r) {
                    var s;
                    return B || "opacity" !== e ? (!n && t.style[e] ? s = t.style[e] : (i = i || Q(t)) ? s = i[e] || i.getPropertyValue(e) || i.getPropertyValue(e.replace(z, "-$1").toLowerCase()) : t.currentStyle && (s = t.currentStyle[e]), null == r || s && "none" !== s && "auto" !== s && "auto auto" !== s ? s : r) : U(t)
                },
                $ = Y.convertToPixels = function(t, i, n, r, s) {
                    if ("px" === r || !r) return n;
                    if ("auto" === r || !n) return 0;
                    var a, l, u, h = C.test(i),
                        c = t,
                        f = X.style,
                        p = 0 > n,
                        d = 1 === n;
                    if (p && (n = -n), d && (n *= 100), "%" === r && -1 !== i.indexOf("border")) a = n / 100 * (h ? t.clientWidth : t.clientHeight);
                        ...
                        if (f.cssText = "border:0 solid red;position:" + Z(t, "position") + ";line-height:0;", "%" !== r && c.appendChild && "v" !== r.charAt(0) && "rem" !== r) f[h ? "borderLeftWidth" : "borderTopWidth"] = n + r;
                        else {
                            if (c = t.parentNode || L.body, l = c._gsCache, u = e.ticker.frame, l && h && l.time === u) return l.width * n / 100;
                            f[h ? "width" : "height"] = n + r
                        }
                        c.appendChild(X), a = parseFloat(X[h ? "offsetWidth" : "offsetHeight"]), c.removeChild(X), h && "%" === r && o.cacheWidths !== !1 && (l = c._gsCache = c._gsCache || {}, l.time = u, l.width = a / n * 100), 0 !== a || s || (a = $(t, i, n, r, !0))
                    }
                ...
                J = function(t, e) {
                    ...
                    if (e = e || Q(t, null))
                        if (i = e.length)
                            for (; --i > -1;) r = e[i], (-1 === r.indexOf("-transform") || Pt === r) && (s[r.replace(P, k)] = e.getPropertyValue(r));
                        else
                            for (i in e)(-1 === i.indexOf("Transform") || zt === i) && (s[i] = e[i]);
                    else if (e = t.currentStyle || t.style)
                        for (i in e) "string" == typeof i && void 0 === s[i] && (s[i.replace(P, k)] = e[i]);
                    return B || (s.opacity = U(t)), n = Xt(t, e, !1), s.rotation = n.rotation, s.skewX = n.skewX, s.scaleX = n.scaleX, s.scaleY = n.scaleY, s.x = n.x, s.y = n.y, kt && (s.z = n.z, s.rotationX = n.rotationX, s.rotationY = n.rotationY, s.scaleZ = n.scaleZ), s.filters && delete s.filters, s
                },
            ...
            var pt = function(t, e, i, n) {
                    ...
                    return h ? r = e ? function(t) {
                        ...
                        if (e = (t.match(ft) || [s])[0], f = t.split(e).join("").match(_) || [], p = f.length, h > p--)
                ...
                _t = o.parseComplex = function(t, e, i, n, r, s, a, l, u, c) {
                    ...
                    var f, p, d, m, _, v, y, x, w, b, T, z, P, O = i.split(", ").join(",").split(" "),
                        k = n.split(", ").join(",").split(" "),
                        C = O.length,
                        S = h !== !1;
                    for ((-1 !== n.indexOf(",") || -1 !== i.indexOf(",")) && (O = O.join(" ").replace(E, ", ").split(" "), k = k.join(" ").replace(E, ", ").split(" "), C = O.length), C !== k.length && (O = (s || "").split(" "), C = O.length), a.plugin = u, a.setRatio = c, ft.lastIndex = 0, f = 0; C > f; f++)
                        if (m = O[f], _ = k[f], x = parseFloat(m), x || 0 === x) a.appendXtra("", x, st(_, x), _.replace(g, ""), S && -1 !== _.indexOf("px"), !0);
                        else if (r && ft.test(m)) z = _.indexOf(")") + 1, z = ")" + (z ? _.substr(z) : ""), P = -1 !== _.indexOf("hsl") && B, m = ht(m, P), _ = ht(_, P), w = m.length + _.length > 6, w && !B && 0 === _[3] ? (a["xs" + a.l] += a.l ? " transparent" : "transparent", a.e = a.e.split(k[f]).join("transparent")) : (B || (w = !1), P ? a.appendXtra(w ? "hsla(" : "hsl(", m[0], st(_[0], m[0]), ",", !1, !0).appendXtra("", m[1], st(_[1], m[1]), "%,", !1).appendXtra("", m[2], st(_[2], m[2]), w ? "%," : "%" + z, !1) : a.appendXtra(w ? "rgba(" : "rgb(", m[0], _[0] - m[0], ",", !0, !0).appendXtra("", m[1], _[1] - m[1], ",", !0).appendXtra("", m[2], _[2] - m[2], w ? "," : z, !0), w && (m = m.length < 4 ? 1 : m[3], a.appendXtra("", m, (_.length < 4 ? 1 : _[3]) - m, z, !1))), ft.lastIndex = 0;
                    else if (v = m.match(R)) {
            ...
            u.xs0 = "", u._next = u._prev = u.xfirst = u.data = u.plugin = u.setRatio = u.rxp = null, u.appendXtra = function(t, e, i, n, r, s) {
                var o = this,
                    a = o.l;
                return o["xs" + a] += s && (a || o["xs" + a]) ? " " + t : t || "", i || 0 === a || o.plugin ? (o.l++, o.type = o.setRatio ? 2 : 1, o["xs" + o.l] = n || "", a > 0 ? (o.data["xn" + a] = e + i, o.rxp["xn" + a] = r, o["xn" + a] = e, o.plugin || (o.xfirst = new Rt(o, "xn" + a, e, i, o.xfirst || o, 0, o.n, r, o.pr), o.xfirst.xs0 = 0), o) : (o.data = {
                    s: e + i
                    ...
                    if (!l[t]) {
                        ...
                        xt(t, {
                            parser: function(t, i, n, r, s, o, u) {
                                ...
                                return h ? (h._cssRegister(), l[n].parse(t, i, n, r, s, o, u)) : (q("Error: " + e + " js file not loaded."), s)
                            }
                        })
                    }
                };
            ...
            var bt, Tt = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
                ...
                Ct = Y.Transform = function() {
                    this.perspective = parseFloat(o.defaultTransformPerspective) || 0, this.force3D = !(o.defaultForce3D === !1 || !kt) && (o.defaultForce3D || "auto")
                },
                ...
                Mt = function() {
                    ...
                    return L.createElementNS && !n && (t = At("svg", Et), e = At("rect", t, {
                        width: 100,
                        height: 50,
                        x: 100
                    }), i = e.getBoundingClientRect().width, e.style[Ot] = "50% 50%", e.style[zt] = "scaleX(0.5)", n = i === e.getBoundingClientRect().width && !(p && kt), Et.removeChild(t)), n
                }(),
                Nt = function(t, e, i, n, r, s) {
                    var a, l, u, h, c, f, p, d, m, R, g, _, v, y, x = t._gsTransform,
                        w = jt(t, !0);
                ...
                jt = function(t, e) {
                    var i, n, r, s, o, a, l = t._gsTransform || new Ct,
                        u = 1e5,
                        h = t.style;
                    if (zt ? n = Z(t, Pt, null, !0) : t.currentStyle && (n = t.currentStyle.filter.match(S), n = n && 4 === n.length ? [n[0].substr(4), Number(n[2].substr(4)), Number(n[1].substr(4)), n[3].substr(4), l.x || 0, l.y || 0].join(",") : ""), i = !n || "none" === n || "matrix(1, 0, 0, 1, 0, 0)" === n, i && zt && ((a = "none" === Q(t).display) || !t.parentNode) && (a && (s = h.display, h.display = "block"), t.parentNode || (o = 1, Et.appendChild(t)), n = Z(t, Pt, null, !0), i = !n || "none" === n || "matrix(1, 0, 0, 1, 0, 0)" === n, s ? h.display = s : a && Bt(h, "display"), o && Et.removeChild(t)), (l.svg || t.getBBox && It(t)) && (i && -1 !== (h[zt] + "").indexOf("matrix") && (n = h[zt], i = 0), r = t.getAttribute("transform"), i && r && (-1 !== r.indexOf("matrix") ? (n = r, i = 0) : -1 !== r.indexOf("translate") && (n = "matrix(1,0,0,1," + r.match(/(?:\-|\b)[\d\-\.e]+\b/gi).join(",") + ")", i = 0))), i) return Lt;
                ...
                Xt = Y.getTransform = function(t, i, n, r) {
                    ...
                    var s, a, l, u, h, c, f = n ? t._gsTransform || new Ct : new Ct,
                        p = f.scaleX < 0,
                        d = 2e-5,
                        m = 1e5,
                        R = kt ? parseFloat(Z(t, Ot, i, !1, "0 0 0").split(" ")[2]) || f.zOrigin || 0 : 0,
                        g = parseFloat(o.defaultTransformPerspective) || 0;
                    if (f.svg = !(!t.getBBox || !It(t)), f.svg && (Nt(t, Z(t, Ot, i, !1, "50% 50%") + "", f, t.getAttribute("data-svg-origin")), bt = o.useSVGTransformAttr || Mt), s = jt(t), s !== Lt) {
                        if (16 === s.length) {
                            var _, v, y, x, w, b = s[0],
                                T = s[1],
                                z = s[2],
                                ...
                                j = s[11],
                                X = Math.atan2(C, M);
                            f.zOrigin && (L = -f.zOrigin, N = A * L - s[12], I = E * L - s[13], L = M * L + f.zOrigin - s[14]), f.rotationX = X * F, X && (x = Math.cos(-X), w = Math.sin(-X), _ = O * x + A * w, v = k * x + E * w, y = C * x + M * w, A = O * -w + A * x, E = k * -w + E * x, M = C * -w + M * x, j = S * -w + j * x, O = _, k = v, C = y), X = Math.atan2(-z, M), f.rotationY = X * F, X && (x = Math.cos(-X), w = Math.sin(-X), _ = b * x - A * w, v = T * x - E * w, y = z * x - M * w, E = T * w + E * x, M = z * w + M * x, j = P * w + j * x, b = _, T = v, z = y), X = Math.atan2(T, b), f.rotation = X * F, X && (x = Math.cos(-X), w = Math.sin(-X), b = b * x + O * w, v = T * x + k * w, k = T * -w + k * x, C = z * -w + C * x, T = v), f.rotationX && Math.abs(f.rotationX) + Math.abs(f.rotation) > 359.9 && (f.rotationX = f.rotation = 0, f.rotationY = 180 - f.rotationY), f.scaleX = (Math.sqrt(b * b + T * T) * m + .5 | 0) / m, f.scaleY = (Math.sqrt(k * k + E * E) * m + .5 | 0) / m, f.scaleZ = (Math.sqrt(C * C + M * M) * m + .5 | 0) / m, f.rotationX || f.rotationY ? f.skewX = 0 : (f.skewX = O || k ? Math.atan2(O, k) * F + f.rotation : f.skewX || 0, Math.abs(f.skewX) > 90 && Math.abs(f.skewX) < 270 && (p ? (f.scaleX *= -1, f.skewX += f.rotation <= 0 ? 180 : -180, f.rotation += f.rotation <= 0 ? 180 : -180) : (f.scaleY *= -1, f.skewX += f.skewX <= 0 ? 180 : -180))), f.perspective = j ? 1 / (0 > j ? -j : j) : 0, f.x = N, f.y = I, f.z = L, f.svg && (f.x -= f.xOrigin - (f.xOrigin * b - f.yOrigin * O), f.y -= f.yOrigin - (f.yOrigin * T - f.xOrigin * k))
                            ...
                            var D = s.length >= 6,
                                ...
                                B = s[2] || 0,
                                U = D ? s[3] : 1;
                            f.x = s[4] || 0, f.y = s[5] || 0, l = Math.sqrt(Y * Y + V * V), u = Math.sqrt(U * U + B * B), h = Y || V ? Math.atan2(V, Y) * F : f.rotation || 0, c = B || U ? Math.atan2(B, U) * F + h : f.skewX || 0, Math.abs(c) > 90 && Math.abs(c) < 270 && (p ? (l *= -1, c += 0 >= h ? 180 : -180, h += 0 >= h ? 180 : -180) : (u *= -1, c += 0 >= c ? 180 : -180)), f.scaleX = l, f.scaleY = u, f.rotation = h, f.skewX = c, kt && (f.rotationX = f.rotationY = f.z = 0, f.perspective = g, f.scaleZ = 1), f.svg && (f.x -= f.xOrigin - (f.xOrigin * Y + f.yOrigin * B), f.y -= f.yOrigin - (f.xOrigin * V + f.yOrigin * U))
                        }
                        f.zOrigin = R;
                ...
                Dt = function(t) {
                    ...
                    if (f) {
                        ...
                        if (null != n.ox && (p = (n.oxp ? R * n.ox * .01 : n.ox) - R / 2, d = (n.oyp ? g * n.oy * .01 : n.oy) - g / 2, w += p - (p * a + d * l), b += d - (p * u + d * h)), _ ? (p = R / 2, d = g / 2, v += ", Dx=" + (p - (p * a + d * l) + w) + ", Dy=" + (d - (p * u + d * h) + b) + ")") : v += ", sizingMethod='auto expand')", -1 !== e.indexOf("DXImageTransform.Microsoft.Matrix(") ? c.filter = e.replace(A, v) : c.filter = v + " " + e, (0 === t || 1 === t) && 1 === a && 0 === l && 0 === u && 1 === h && (_ && -1 === v.indexOf("Dx=0, Dy=0") || x.test(e) && 100 !== parseFloat(RegExp.$1) || -1 === e.indexOf(e.indexOf("Alpha")) && c.removeAttribute("filter")), !_) {
                            var T, z, P, O = 8 > m ? 1 : -1;
                            for (p = n.ieOffsetX || 0, d = n.ieOffsetY || 0, n.ieOffsetX = Math.round((R - ((0 > a ? -a : a) * R + (0 > l ? -l : l) * g)) / 2 + w), n.ieOffsetY = Math.round((g - ((0 > h ? -h : h) * g + (0 > u ? -u : u) * R)) / 2 + b), vt = 0; 4 > vt; vt++) z = it[vt], T = f[z], i = -1 !== T.indexOf("px") ? parseFloat(T) : $(this.t, z, parseFloat(T), T.replace(y, "")) || 0, P = i !== n[z] ? 2 > vt ? -n.ieOffsetX : -n.ieOffsetY : 2 > vt ? p - n.ieOffsetX : d - n.ieOffsetY, c[z] = (n[z] = Math.round(i - P * (0 === vt || 2 === vt ? 1 : O))) + "px"
                        }
                    }
                },
                Yt = Y.set3DTransformRatio = Y.setTransformRatio = function(t) {
                    var e, i, n, r, s, o, a, l, u, h, c, f, d, m, R, g, _, v, y, x, w, b, T, z = this.data,
                        P = this.t.style,
                        O = z.rotation,
                        k = z.rotationX,
                        C = z.rotationY,
                        ...
                        j = z.perspective,
                        X = z.force3D;
                    if (((1 === t || 0 === t) && "auto" === X && (this.tween._totalTime === this.tween._totalDuration || !this.tween._totalTime) || !X) && !I && !j && !C && !k && 1 === E || bt && L || !kt) return void(O || z.skewX || L ? (O *= N, b = z.skewX * N, T = 1e5, e = Math.cos(O) * S, r = Math.sin(O) * S, i = Math.sin(O - b) * -A, s = Math.cos(O - b) * A, b && "simple" === z.skewType && (_ = Math.tan(b), _ = Math.sqrt(1 + _ * _), i *= _, s *= _, z.skewY && (e *= _, r *= _)), L && (M += z.xOrigin - (z.xOrigin * e + z.yOrigin * i) + z.xOffset, F += z.yOrigin - (z.xOrigin * r + z.yOrigin * s) + z.yOffset, bt && (z.xPercent || z.yPercent) && (m = this.t.getBBox(), M += .01 * z.xPercent * m.width, F += .01 * z.yPercent * m.height), m = 1e-6, m > M && M > -m && (M = 0), m > F && F > -m && (F = 0)), y = (e * T | 0) / T + "," + (r * T | 0) / T + "," + (i * T | 0) / T + "," + (s * T | 0) / T + "," + M + "," + F + ")", L && bt ? this.t.setAttribute("transform", "matrix(" + y) : P[zt] = (z.xPercent || z.yPercent ? "translate(" + z.xPercent + "%," + z.yPercent + "%) matrix(" : "matrix(") + y) : P[zt] = (z.xPercent || z.yPercent ? "translate(" + z.xPercent + "%," + z.yPercent + "%) matrix(" : "matrix(") + S + ",0,0," + A + "," + M + "," + F + ")");
                    if (p && (m = 1e-4, m > S && S > -m && (S = E = 2e-5), m > A && A > -m && (A = E = 2e-5), !j || z.z || z.rotationX || z.rotationY || (j = 0)), O || z.skewX) O *= N, R = e = Math.cos(O), g = r = Math.sin(O), z.skewX && (O -= z.skewX * N, R = Math.cos(O), g = Math.sin(O), "simple" === z.skewType && (_ = Math.tan(z.skewX * N), _ = Math.sqrt(1 + _ * _), R *= _, g *= _, z.skewY && (e *= _, r *= _))), i = -g, s = R;
                    else {
                        if (!(C || k || 1 !== E || j || L)) return void(P[zt] = (z.xPercent || z.yPercent ? "translate(" + z.xPercent + "%," + z.yPercent + "%) translate3d(" : "translate3d(") + M + "px," + F + "px," + I + "px)" + (1 !== S || 1 !== A ? " scale(" + S + "," + A + ")" : ""));
                        e = s = 1, i = r = 0
                    }
                    u = 1, n = o = a = l = h = c = 0, f = j ? -1 / j : 0, d = z.zOrigin, m = 1e-6, x = ",", w = "0", O = C * N, O && (R = Math.cos(O), g = Math.sin(O), a = -g, h = f * -g, n = e * g, o = r * g, u = R, f *= R, e *= R, r *= R), O = k * N, O && (R = Math.cos(O), g = Math.sin(O), _ = i * R + n * g, v = s * R + o * g, l = u * g, c = f * g, n = i * -g + n * R, o = s * -g + o * R, u *= R, f *= R, i = _, s = v), 1 !== E && (n *= E, o *= E, u *= E, f *= E), 1 !== A && (i *= A, s *= A, l *= A, c *= A), 1 !== S && (e *= S, r *= S, a *= S, h *= S), (d || L) && (d && (M += n * -d, F += o * -d, I += u * -d + d), L && (M += z.xOrigin - (z.xOrigin * e + z.yOrigin * i) + z.xOffset, F += z.yOrigin - (z.xOrigin * r + z.yOrigin * s) + z.yOffset), m > M && M > -m && (M = w), m > F && F > -m && (F = w), m > I && I > -m && (I = 0)), y = z.xPercent || z.yPercent ? "translate(" + z.xPercent + "%," + z.yPercent + "%) matrix3d(" : "matrix3d(", y += (m > e && e > -m ? w : e) + x + (m > r && r > -m ? w : r) + x + (m > a && a > -m ? w : a), y += x + (m > h && h > -m ? w : h) + x + (m > i && i > -m ? w : i) + x + (m > s && s > -m ? w : s), k || C || 1 !== E ? (y += x + (m > l && l > -m ? w : l) + x + (m > c && c > -m ? w : c) + x + (m > n && n > -m ? w : n), y += x + (m > o && o > -m ? w : o) + x + (m > u && u > -m ? w : u) + x + (m > f && f > -m ? w : f) + x) : y += ",0,0,0,0,1,0,", y += M + x + F + x + I + x + (j ? 1 + -I / j : 1) + ")", P[zt] = y
                };
            u = Ct.prototype, u.x = u.y = u.z = u.skewX = u.skewY = u.rotation = u.rotationX = u.rotationY = u.zOrigin = u.xPercent = u.yPercent = u.xOffset = u.yOffset = 0, u.scaleX = u.scaleY = u.scaleZ = 1, xt("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
                parser: function(t, e, i, n, s, a, l) {
                    ...
                    var u, h, c, f, p, d, m, R, g, _ = t._gsTransform,
                        v = t.style,
                        y = 1e-6,
                        x = Tt.length,
                        w = l,
                    ...
                    if (n._transform = z, "string" == typeof w.transform && zt) h = X.style, h[zt] = w.transform, h.display = "block", h.position = "absolute", L.body.appendChild(X), u = Xt(X, null, !1), z.svg && (m = z.xOrigin, R = z.yOrigin, u.x -= z.xOffset, u.y -= z.yOffset, (w.transformOrigin || w.svgOrigin) && (c = {}, Nt(t, rt(w.transformOrigin), c, w.svgOrigin, w.smoothOrigin, !0), m = c.xOrigin, R = c.yOrigin, u.x -= c.xOffset - z.xOffset, u.y -= c.yOffset - z.yOffset), (m || R) && (g = jt(X, !0), u.x -= m - (m * g[0] + R * g[2]), u.y -= R - (m * g[1] + R * g[3]))), L.body.removeChild(X), u.perspective || (u.perspective = z.perspective), null != w.xPercent && (u.xPercent = ot(w.xPercent, z.xPercent)), null != w.yPercent && (u.yPercent = ot(w.yPercent, z.yPercent));
                ...
                parser: function(t, e, i, n, s, o) {
                    var a, l, u, h, c, f, p = "background-position",
                        d = r || Q(t, null),
                        R = this.format((d ? m ? d.getPropertyValue(p + "-x") + " " + d.getPropertyValue(p + "-y") : d.getPropertyValue(p) : t.currentStyle.backgroundPositionX + " " + t.currentStyle.backgroundPositionY) || "0 0"),
                        g = this.format(e);
                    if (-1 !== R.indexOf("%") != (-1 !== g.indexOf("%")) && g.split(",").length < 2 && (f = Z(t, "backgroundImage").replace(O, ""), f && "none" !== f)) {
            ...
            xt("className", {
                parser: function(t, e, n, s, o, a, l) {
                    var u, h, c, f, p, d = t.getAttribute("class") || "",
                        m = t.style.cssText;
                    if (o = s._classNamePT = new Rt(t, n, 0, 0, o, 2), o.setRatio = Ut, o.pr = -11, i = !0, o.b = d, h = J(t, r), c = t._gsClassPT) {
            ...
            var qt = function(t) {
                if ((1 === t || 0 === t) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                    ...
                    if ("all" === this.e) o.cssText = "", r = !0;
                        ...
                        for (e = this.e.split(" ").join("").split(","), n = e.length; --n > -1;) i = e[n], l[i] && (l[i].parse === a ? r = !0 : i = "transformOrigin" === i ? Ot : l[i].p), Bt(o, i);
            ...
            for (xt("clearProps", {
                    parser: function(t, e, n, r, s) {
                        return s = new Rt(t, n, 0, 0, s, 2), s.setRatio = qt, s.e = e, s.pr = -10, s.data = r._tween, i = !0, s
                    }
            ...
            u = o.prototype, u._firstPT = u._lastParsedTransform = u._transform = null, u._onInitTween = function(t, e, a) {
                ...
                if (c && "" === b.zIndex && (u = Z(t, "zIndex", r), ("auto" === u || "" === u) && this._addLazySet(b, "zIndex", 0)), "string" == typeof e && (R = b.cssText, u = J(t, r), b.cssText = R + ";" + e, u = tt(t, u, J(t)).difs, !B && w.test(e) && (u.opacity = parseFloat(RegExp.$1)), e = u, b.cssText = R), e.className ? this._firstPT = p = l.className.parse(t, e.className, "className", this, null, null, e) : this._firstPT = p = this.parse(t, e, null), this._transformType) {
                    ...
                    y = new Rt(t, "transform", 0, 0, null, 2), this._linkCSSP(y, null, m), y.setRatio = zt ? Yt : Dt, y.data = this._transform || Xt(t, r, !0), y.tween = a, y.pr = -1, s.pop()
                }
                if (i) {
                    for (; p;) {
                ...
                for (o in e) p = e[o], a = l[o], a ? i = a.parse(t, p, o, this, i, s, e) : (f = Z(t, o, r) + "", R = "string" == typeof p, "color" === o || "fill" === o || "stroke" === o || -1 !== o.indexOf("Color") || R && T.test(p) ? (R || (p = ht(p), p = (p.length > 3 ? "rgba(" : "rgb(") + p.join(",") + ")"), i = _t(_, o, f, p, !0, "transparent", i, 0, s)) : R && M.test(p) ? i = _t(_, o, f, p, !0, null, i, 0, s) : (u = parseFloat(f), d = u || 0 === u ? f.substr((u + "").length) : "", ("" === f || "auto" === f) && ("width" === o || "height" === o ? (u = nt(t, o, r), d = "px") : "left" === o || "top" === o ? (u = K(t, o, r), d = "px") : (u = "opacity" !== o ? 0 : 1, d = "")), g = R && "=" === p.charAt(1), g ? (c = parseInt(p.charAt(0) + "1", 10), p = p.substr(2), c *= parseFloat(p), m = p.replace(y, "")) : (c = parseFloat(p), m = R ? p.replace(y, "") : ""), "" === m && (m = o in n ? n[o] : d), p = c || 0 === c ? (g ? c + u : c) + m : e[o], d !== m && "" !== m && (c || 0 === c) && u && (u = $(t, o, u, d), "%" === m ? (u /= $(t, o, 100, "%") / 100, e.strictUnits !== !0 && (f = u + "%")) : "em" === m || "rem" === m || "vw" === m || "vh" === m ? u /= $(t, o, 1, m) : "px" !== m && (c = $(t, o, c, m), m = "px"), g && (c || 0 === c) && (p = c + u + m)), g && (c += u), !u && 0 !== u || !c && 0 !== c ? void 0 !== _[o] && (p || p + "" != "NaN" && null != p) ? (i = new Rt(_, o, c || u || 0, 0, i, (-1), o, (!1), 0, f, p), i.xs0 = "none" !== p || "display" !== o && -1 === o.indexOf("Style") ? p : f) : q("invalid " + o + " tween value: " + e[o]) : (i = new Rt(_, o, u, c - u, i, 0, o, h !== !1 && ("px" === m || "zIndex" === o), 0, f, p), i.xs0 = m))), s && i && !i.plugin && (i.plugin = s);
                return i
                ...
                this._transform = this._transform || Xt(this._target, r, !0), this._transformType = this._transform.svg && bt || !t && 3 !== this._transformType ? 2 : 3
            };
            var Gt = function(t) {
            ...
            return o.cascadeTo = function(t, i, n) {
                ...
                for (t = l._targets || l.target, Wt(t, h, f), l.render(i, !0, !0), Wt(t, c), l.render(0, !0, !0), l._enabled(!0), r = f.length; --r > -1;)
    ...
    function(t) {
        ...
        return function(t) {
            ...
            Object.defineProperty(e, "__esModule", {
                value: !0
            }), e.extend = i, e.mapString = n, e.sample = r, e.each = s, e.getTruthyIndices = o, e.getElements = a
        }, function(t, e, i) {
            "use strict";
        ...
        return function(t) {
            ...
            function n(t, e, i) {
                ...
                return e = o(e) || 0, r(i) && (z = !!i.leading, P = "maxWait" in i, y = P ? l(o(i.maxWait) || 0, e) : y, O = "trailing" in i ? !!i.trailing : O), g.cancel = m, g.flush = R, g
            }
            var r = i(2),
                s = i(7),
                o = i(9),
...
var Util = function(t) {
        ...
        var e = t(".main-navigation"),
            ...
            f = function() {
                console.info(" Made with ❤️ by Jay ")
            },
            p = function() {
                o(), a(), r(), s(), n(), l()
            };
                    ...
                    var a = i.serialize();
                     Util.sendGAEvent("Contact", "Try Contact me", !1), e.addClass("is-form-processing"), t.ajax({
                        ...
                        s.text(t), setTimeout(function() {
                            ...
                            e.removeClass("error"), r.prop("disabled", !0)
                        }, 7e3), Util.sendGAEvent("Contact", "Contact Success", !1), i.find("input, textarea").val("")
                    }).fail(function(t) {
                        "" !== t.responseText ? s.text(t.responseText) : s.text("An error is not occured your message has been sent."), setTimeout(function() {
                            e.removeClass("success").addClass("error")
                        }, 2e3), setTimeout(function() {
                            e.removeClass("is-form-processing")
                        }, 6e3), setTimeout(function() {
    ...
    AnimationManager = function(t) {
        ...
        var e = function(e) {
            ...
            o = function() {
                ...
                e.length && (e.addClass("is-loaded"), Modernizr.mq("(min-width: 1024px)") && window.baffle(document.querySelectorAll(".stripe-baffle"), {
                    characters: "█▓▒░█▓▒░█▓▒░<>/"
            ...
            l = function() {
                Modernizr.mq("(min-width: 1024px)") && new Vivus("logo-anim", {
                    duration: 55
                })
            },
            u = function() {
            ...
            f = function(e, i) {
                ...
                t("body").removeClass("bright-theme"), r.removeClass("is-hidden"), o > 0 ? TweenLite.to(window, .5, {
                    scrollTo: {
                        y: 0
                    },
                    ease: Power4.easeInOut,
            ...
            p = function(e, n) {
                ...
                setTimeout(function() {
                    ...
                    TweenLite.to(h, 1, {
                        ...
                        ease: Power4.easeInOut,
                        onComplete: function() {
                            Util.init(), Util.onPageVisibilityChange(), Navigation.init(), Form.init(), Cookie.init(), AnimationManager.init(), i(), t(".main-hero").length && AnimationManager.animateHeroShapes(), u(), r(), a(), s(), o(), l()
                        }
                    }), TweenLite.to(f, 1, {
                        x: "-100%",
                        ease: Power4.easeInOut,
            ...
            _ = function() {
                if (Modernizr.mq("(min-width: 1024px)")) {
                    var e = t(".experiments-mask-reveal"),
                        i = e.find("span:first"),
                        n = e.find("span:last");
                    t(".case-study").addClass("is-hidden"), t(".section-text-mask").addClass("is-hidden"), t(".single-work-intro-title").addClass("is-hidden"), t(".single-work-anim-text").addClass("is-hidden"), t(".single-work-first-anim-blocks").addClass("is-hidden"), t(".color-palette-container").addClass("is-hidden"), TweenLite.to(i, 0, {
                        y: "0",
                        ease: Power4.easeInOut
                    }), TweenLite.to(n, 0, {
                        y: "0",
    ...
    Application = function(t) {
        ...
        var e = function() {
            document.documentElement.className = "js", t(document).on("ready", function() {
                Util.init(), Util.onPageVisibilityChange(), Util.addConsoleCopy(), Navigation.init(), Form.init(), Cookie.init(), AnimationManager.init(), t(".main-hero").length && AnimationManager.animateHeroShapes()
